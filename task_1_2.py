...
Для формирования списка необходима память. Поэтому func_1 использовала 
18.3125 MiB дополнительной памяти.

Если нет необходимости обязательно возвращать список (например, в дальнейшем
будет производиться обработка списка с помощью итерации), то в качестве 
возвращаемого значения можно использовать итератор (для функции func_2
...
больших списках, время выполнения функции уменьшается: 0.1033 против 0.2069.
"""
